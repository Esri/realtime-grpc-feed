...
SERVER_URL = "velocitydemo.arcgis.com"
SERVER_HEARDER = "bc1qjuyagnrebxvh.fa1d5d06c61749b38b6f5adf7238b302"
...
def data_collection():
    ...
    df = [
        [39.29242438926388, -76.6666720609419, "9:17AM", False, 4, "1636384539"],
...
def wrap_data(df):
    ...
    for data in df_copy:
        for i in range(0, len(SCHEMA)):
            ...
            elif SCHEMA[i] == "Float64":
                data[i] = wrappers.DoubleValue(value=data[i])
...
def create_channel():
    ...
    """
    # create credentials for the channel
...
def send_blocking(stub, metadata, features):
    ...
    for feature in features:
        res = stub.Send(
            request=velocity_grpc_pb2.Request(features=[feature]), metadata=metadata
        )
